...
class RadioBoxButton : RadioButton
{
    /// <summary>
    ...
    public RadioBoxButton(int width, int height)
        : base(width, height)
    {}
    ...
    public override void UpdateAndRedraw(TimeSpan time)
    {
        ...
        if (IsSelected) {
            topleftcolor = !mouseDown ? colors.Orange.GetBrighter() : colors.Orange.GetDarker();
            bottomrightcolor = !mouseDown ? colors.Orange.GetDarker() : colors.Orange.GetBrighter();
        }
